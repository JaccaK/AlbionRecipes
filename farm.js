...
var produce = "T3_EGG,T4_MILK,T5_EGG,T6_MILK,T8_MILK"
    ...
    var animalRecipes = [
                ...
                new Animal("T5_FARM_OWL_FW_BRECILIEN_BABY","T5_FARM_OWL_FW_BRECILIEN_GROWN",1,"meat",calcMaxNutri(140,116),1488,3,0,0.1),
                ...
                new Animal("T8_FARM_OWL_FW_BRECILIEN_BABY","T8_FARM_OWL_FW_BRECILIEN_GROWN",1,"meat",calcMaxNutri(284,9),19728,6,0,0.025),
    ...
    $(document).ready(function(){
      ...
      $("#citybonus").change(function() { updateTableValues() })
