    ...
    var recipes = [
                  ...
                  new Recipe("T3_MEAL_OMELETTE_AVALON", new Map([["T4_MILK",4],["T3_MEAT",8],["T3_EGG",2],["QUESTITEM_TOKEN_AVALON",10]]),1.35,10),
                  new Recipe("T5_MEAL_OMELETTE_AVALON", new Map([["T6_MILK",12],["T5_MEAT",24],["T5_EGG",6],["QUESTITEM_TOKEN_AVALON",30]]),4.05,10),
                  new Recipe("T7_MEAL_OMELETTE_AVALON", new Map([["T8_MILK",36],["T7_MEAT",72],["T5_EGG",18],["QUESTITEM_TOKEN_AVALON",90]]),12.15,10),
                  new Recipe("T7_MEAL_OMELETTE_AVALON@1", new Map([["T8_MILK",36],["T7_MEAT",72],["T5_EGG",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL1",90]]),12.15,10),
                  new Recipe("T7_MEAL_OMELETTE_AVALON@2", new Map([["T8_MILK",36],["T7_MEAT",72],["T5_EGG",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL2",90]]),12.15,10),
                  new Recipe("T7_MEAL_OMELETTE_AVALON@3", new Map([["T8_MILK",36],["T7_MEAT",72],["T5_EGG",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL3",90]]),12.15,10),
                  ...
                  new Recipe("T4_MEAL_STEW_AVALON", new Map([["T1_CARROT",4],["T4_TURNIP",4],["T4_MEAT",8],["QUESTITEM_TOKEN_AVALON",10]]),1.44,10),
                  new Recipe("T6_MEAL_STEW_AVALON", new Map([["T5_CABBAGE",12],["T6_POTATO",12],["T6_MEAT",24],["QUESTITEM_TOKEN_AVALON",30]]),4.32,10),
                  new Recipe("T8_MEAL_STEW_AVALON", new Map([["T7_CORN",36],["T8_PUMPKIN",36],["T8_MEAT",72],["QUESTITEM_TOKEN_AVALON",90]]),12.96,10),
                  new Recipe("T8_MEAL_STEW_AVALON@1", new Map([["T7_CORN",36],["T8_PUMPKIN",36],["T8_MEAT",72],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL1",90]]),12.96,10),
                  new Recipe("T8_MEAL_STEW_AVALON@2", new Map([["T7_CORN",36],["T8_PUMPKIN",36],["T8_MEAT",72],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL2",90]]),12.96,10),
                  new Recipe("T8_MEAL_STEW_AVALON@3", new Map([["T7_CORN",36],["T8_PUMPKIN",36],["T8_MEAT",72],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL3",90]]),12.96,10),
                  ...
                  new Recipe("T4_MEAL_SANDWICH_AVALON", new Map([["T4_BREAD",4],["T4_MEAT",8],["T4_BUTTER",2],["QUESTITEM_TOKEN_AVALON",10]]),1.35,10),
                  new Recipe("T6_MEAL_SANDWICH_AVALON", new Map([["T4_BREAD",12],["T6_MEAT",24],["T6_BUTTER",6],["QUESTITEM_TOKEN_AVALON",30]]),4.05,10),
                  new Recipe("T8_MEAL_SANDWICH_AVALON", new Map([["T4_BREAD",36],["T8_MEAT",72],["T8_BUTTER",18],["QUESTITEM_TOKEN_AVALON",90]]),12.15,10),
                  new Recipe("T8_MEAL_SANDWICH_AVALON@1", new Map([["T4_BREAD",36],["T8_MEAT",72],["T8_BUTTER",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL1",90]]),12.15,10),
                  new Recipe("T8_MEAL_SANDWICH_AVALON@2", new Map([["T4_BREAD",36],["T8_MEAT",72],["T8_BUTTER",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL2",90]]),12.15,10),
                  new Recipe("T8_MEAL_SANDWICH_AVALON@3", new Map([["T4_BREAD",36],["T8_MEAT",72],["T8_BUTTER",18],["QUESTITEM_TOKEN_AVALON",90],["T1_FISHSAUCE_LEVEL3",90]]),12.15,10),
